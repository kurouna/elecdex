...
const PASSES_NOW = DEMO_FILES['src/orbit/passes.ts']
  .join('\n')
  .replace(
    "import { lookAngles } from './look'",
...
function demoRepository() {
  ...
  // Not yet committed: the work the agent in the AGENT shot is doing.
 ...
 */
const REPO_ID = '0e1ec0de0e1ec0de'
const SESSION = '5e551011-0000-4000-8000-00000000a9e1'
const OTHER = '5e551011-0000-4000-8000-00000000b7c2'
