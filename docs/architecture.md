...
| カレンダーと祝日 | 日本の祝日は法律の規則（固定日・ハッピーマンデー・春分/秋分の近似式・振替休日・国民の休日、2019〜2021年の特例）から計算する。2000〜2099年が対象。タイムゾーンが Asia/Tokyo か言語が日本語のときに表示 | ネットワークを使わず、年ごとのデータ更新も要らない。内閣府の公表一覧（2019・2020・2021・2025・2026年）と一致することを単体テストで確認。春分・秋分は前年に官報で確定するが、近似式は対象期間で一致する |
