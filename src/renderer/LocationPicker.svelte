...
{#if request !== null}
  ...
  <div class="backdrop" transition:backdropShade onpointerdown={(e) => e.target === e.currentTarget && ui.closeLocationPicker()}>
    <div class="picker crt-on" style:--crt-delay={dialogDelay()} transition:crtPower role="dialog" aria-modal="true" aria-label="Weather location" data-testid="location-picker">
